...
export const MEAL_OPTION_CHOICES = [
  { value: 'veg', label: 'Vegetarian only (veg track)' },
  { value: 'non_veg', label: 'Non-vegetarian only (non-veg track)' },
...
const MealOptionsField = ({ value = [], onChange }) => {
  ...
  return (
    <div className="form-group full-width">
      <label className="form-label">Meal preference tracks</label>
      <p className="form-help" style={{ marginBottom: '0.75rem' }}>
        Choose which meal options appear on the booking form. Use veg-only or non-veg-only for separate side batches.
        Leave all unchecked to show every option.
      </p>
